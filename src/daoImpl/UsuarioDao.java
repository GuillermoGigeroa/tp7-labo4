...
//	Metodo agregar persona
	...
	public int agregarUsuario(Usuario user) {
		String query = "insert into usuarios (nombreUsuario, pass, tipoUsuario, dni, nombre, apellido) values ('" + user.getNombreUsuario() + "','" + user.getPassword() + "', " + user.getTipoUsuario()+",'" + user.getDni()+"','" + user.getNombre()+"','" + user.getApellido()+"')";
...
//	Metodo listar personas
	...
	public Boolean modificarUsuario(String _nombreUsuario, String _password, int _tipoUsuario, String _dni, String _nombre, String _apellido) {
		...
		try {
			Statement st = conectar.conexion().createStatement();
			String query = "Update usuarios set nombreUsuario = '" +_nombreUsuario+"', pass = '" +_password+ "' , tipoUsuario = " +_tipoUsuario+ ", nombre = '" +_nombre+ "', apellido = '" + _apellido+ "' where dni = "+_dni+ "";
